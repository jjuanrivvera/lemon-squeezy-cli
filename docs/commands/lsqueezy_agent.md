...
Generate AI-agent safety config from the live command tree
...
* [lsqueezy agent guard](lsqueezy_agent_guard.md)	 - Emit host safety config that blocks destructive ops for an agent driving lsqueezy
