...
* [lsqueezy mcp claude disable](lsqueezy_mcp_claude_disable.md)	 - Remove server from Claude config
* [lsqueezy mcp claude enable](lsqueezy_mcp_claude_enable.md)	 - Add server to Claude config
* [lsqueezy mcp claude list](lsqueezy_mcp_claude_list.md)	 - Show Claude MCP servers
