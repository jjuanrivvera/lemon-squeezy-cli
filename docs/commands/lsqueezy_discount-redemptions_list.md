## lsqueezy discount-redemptions list

List discount-redemptions

```
lsqueezy discount-redemptions list [flags]
```

### Examples

```
  lsqueezy discount-redemptions list --limit 25
  lsqueezy discount-redemptions list -o json --all
```

### Options

```
      --discount-id string   filter: discount id
  -h, --help                 help for list
      --include strings      embed related resources: discount,order
      --order-id string      filter: order id
```
