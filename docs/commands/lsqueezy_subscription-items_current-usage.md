## lsqueezy subscription-items current-usage

Show current usage for a usage-based subscription item

```
lsqueezy subscription-items current-usage <id> [flags]
```

### Examples

```
  lsqueezy subscription-items current-usage 1 -o json
```
