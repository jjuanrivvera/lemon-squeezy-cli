...
```
lsqueezy usage-records create [flags]
```

### Examples

```
  lsqueezy usage-records create --data '{"name":"Acme"}' --rel store=stores:1
  lsqueezy usage-records create --set name=Acme --set email=a@b.co --rel store=stores:1 --dry-run
```
