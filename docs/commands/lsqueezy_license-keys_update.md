## lsqueezy license-keys update

Update a license-key by id

```
lsqueezy license-keys update <id> [flags]
```

### Examples

```
  lsqueezy license-keys update 42 --set name=NewName
  lsqueezy license-keys update 42 --data '{"status":"archived"}' --dry-run
```
