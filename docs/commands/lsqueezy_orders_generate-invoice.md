## lsqueezy orders generate-invoice

Generate a downloadable invoice for an order

```
lsqueezy orders generate-invoice <id> [flags]
```

### Examples

```
  lsqueezy orders generate-invoice 12345 --name 'Acme' --country US
```
