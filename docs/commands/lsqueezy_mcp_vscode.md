...
* [lsqueezy mcp vscode disable](lsqueezy_mcp_vscode_disable.md)	 - Remove server from VSCode config
* [lsqueezy mcp vscode enable](lsqueezy_mcp_vscode_enable.md)	 - Add server to VSCode config
* [lsqueezy mcp vscode list](lsqueezy_mcp_vscode_list.md)	 - Show VSCode MCP servers
