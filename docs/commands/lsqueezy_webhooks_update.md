## lsqueezy webhooks update

Update a webhook by id

```
lsqueezy webhooks update <id> [flags]
```

### Examples

```
  lsqueezy webhooks update 42 --set name=NewName
  lsqueezy webhooks update 42 --data '{"status":"archived"}' --dry-run
```
