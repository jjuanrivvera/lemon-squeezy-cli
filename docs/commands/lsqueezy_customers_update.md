## lsqueezy customers update

Update a customer by id

```
lsqueezy customers update <id> [flags]
```

### Examples

```
  lsqueezy customers update 42 --set name=NewName
  lsqueezy customers update 42 --data '{"status":"archived"}' --dry-run
```
