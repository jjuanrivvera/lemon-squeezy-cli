...
* [lsqueezy alias list](lsqueezy_alias_list.md)	 - List defined aliases
* [lsqueezy alias remove](lsqueezy_alias_remove.md)	 - Remove an alias
* [lsqueezy alias set](lsqueezy_alias_set.md)	 - Define an alias (expansion may be multiple words)
