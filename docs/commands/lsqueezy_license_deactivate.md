## lsqueezy license deactivate

Deactivate a license key instance (IRREVERSIBLE)

```
lsqueezy license deactivate [flags]
```
...
```
  -h, --help                 help for deactivate
      --instance-id string   instance id to deactivate (required)
