## lsqueezy discount-redemptions

Browse discount redemptions (read-only)

### Options

```
  -h, --help   help for discount-redemptions
```
...
* [lsqueezy discount-redemptions get](lsqueezy_discount-redemptions_get.md)	 - Get a single discount-redemption by id
* [lsqueezy discount-redemptions list](lsqueezy_discount-redemptions_list.md)	 - List discount-redemptions
