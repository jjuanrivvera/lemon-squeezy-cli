...
* [lsqueezy discounts create](lsqueezy_discounts_create.md)	 - Create a discount
* [lsqueezy discounts delete](lsqueezy_discounts_delete.md)	 - Delete a discount by id
* [lsqueezy discounts get](lsqueezy_discounts_get.md)	 - Get a single discount by id
* [lsqueezy discounts list](lsqueezy_discounts_list.md)	 - List discounts
